...
class ItemsService @Autowired constructor (
    ...
    fun seedItems() {
        val items = listOf(
            ...
            ItemsModel(id = 16, name = "European Kiss", price = BigDecimal("16"), description = "Zacappa 23, pineapple, cilantro, and lemon juice."),
            ...
            ItemsModel(id = 20, name = "Watermelon RedBull", price = BigDecimal("8"), description = ""),
        )
